 ...
 */
export function fAdd({ years = 0, months = 0, days = 0, hours = 0, minutes = 0, seconds = 0, milliseconds = 0 }) {
  const result = dayjs()
    .add(
      dayjs.duration({
        years,
...
/** output: '2024-05-28T05:55:31+00:00'
 */
export function fSub({ years = 0, months = 0, days = 0, hours = 0, minutes = 0, seconds = 0, milliseconds = 0 }) {
  const result = dayjs()
    .subtract(
      dayjs.duration({
        years,
...
/**
 * Returns the UTC date at 06:00:00.
 * Example Output: '2025-02-11 06:00:00'
 */
export function startDayUTC(date = dayjs()) {
  return dayjs(date).utc().startOf('day').add(6, 'hours').format('YYYY-MM-DD HH:mm:ss');
}

export function endDayUTC(date = dayjs()) {
  return dayjs(date).utc().endOf('day').add(6, 'hours').subtract(1, 'second').format('YYYY-MM-DD HH:mm:ss');
}
