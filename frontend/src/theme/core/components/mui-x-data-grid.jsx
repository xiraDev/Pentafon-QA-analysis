...
const MuiDataGrid = {
  ...
  defaultProps: {
    slots: {
      /* Column */
      columnSortedAscendingIcon: (props) => <DataGridArrowUpIcon sx={{ color: 'text.primary' }} {...props} />,
      columnSortedDescendingIcon: (props) => <DataGridArrowDownIcon sx={{ color: 'text.primary' }} {...props} />,
      ...
      columnFilteredIcon: (props) => <DataGridFilterIcon sx={{ width: 16, color: 'text.primary' }} {...props} />,
      /* Density */
